...
#ifndef DCENTBIOMETRIC_SWIFT_H
#define DCENTBIOMETRIC_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="DcentBiometric",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
# pragma pop_macro("any")
#endif

#if defined(__OBJC__)

SWIFT_CLASS("_TtC14DcentBiometric13BleDeviceInfo")
...
@interface BleDeviceInfo (SWIFT_EXTENSION(DcentBiometric)) <CBPeripheralDelegate>
...
SWIFT_CLASS("_TtC14DcentBiometric10RLPElement")
@interface RLPElement : NSObject
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end


SWIFT_CLASS("_TtC14DcentBiometric7RLPList")
@interface RLPList : NSObject
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
